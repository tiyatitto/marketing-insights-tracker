        ...
        return (
            <div className="mb-4 relative">
                ...
                <textarea 
                    ref={ref}
                    rows={3}
                    className={`w-full rounded-xl border px-4 py-2.5 text-black placeholder:text-slate-400 transition-all focus:outline-none focus:ring-4 shadow-sm resize-y ${
                        requiredAttention 
