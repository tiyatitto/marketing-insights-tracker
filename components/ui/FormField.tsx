...
export function FormField({ label, name, type = "text", value = "", onChange, requiredAttention = false }: FormFieldProps) {
    return (
        <div className="mb-4 relative">
            ...
            <input 
                ...
                value={value} 
                onChange={onChange} 
                className={`w-full rounded-xl border px-4 py-2.5 text-slate-900 placeholder-slate-400 transition-all focus:outline-none focus:ring-4 shadow-sm ${
                    requiredAttention 
